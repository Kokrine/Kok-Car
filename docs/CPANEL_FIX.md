...
Python-ს, რომელსაც ბოტი იყენებს → აინსტალირებს მოდულს და დამოკიდებულებებს →
ამუშავებს Chromium-ს (თუ არ ეშვება, თავად გამოცდის კონფიგურაციებს) → წერს
`.env.vinpro`-ს → და **ბოლოს გაჩვენებს ბოტის ზუსტ ხაზებს**, რომლებიც უნდა
შეიცვალოს.

## გასწორება — ძველი ინსტალატორი
